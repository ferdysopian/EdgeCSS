        ...
        <div className='container mx-auto px-4 py-12'>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className='mt-12 max-w-3xl mx-auto'>
                ...
                <ol className='list-decimal list-inside text-gray-600 space-y-2'>
                    ...
                    <li>
                        <p className='mb-2'>Add the following code to the head of your HTML document:</p>
                    ...
                    <li>
                        <p className='mb-2'>Include a script to apply the Critical CSS only during the initial load and disable it afterward:</p>
                        <div className='bg-gray-900 rounded-lg p-4 mb-4'>
                            <div className='flex justify-between items-center mb-4'>
                                <div className='space-x-2'>
                                    <button
